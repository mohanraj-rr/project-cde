...
$sql = "SELECT * FROM `guide` WHERE `guideid`='$gid'";
        ...
        <div class="row">
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <!-- </div> --> 
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Designation</label><input type="text" class="form-control" value="<?php echo $row['designation']?>" readonly></div>
                        <div class="col-md-12"><label class="labels">College Centre</label><input type="text" class="form-control"  value="<?php echo $row['college']?>" readonly></div>
